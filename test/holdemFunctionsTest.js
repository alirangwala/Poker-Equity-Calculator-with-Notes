...
// xdescribe("Individual Hand Ranking Functions", function () {
//   before(function () {
...
// xdescribe("Measure hand strength", function () {
//   before(function () {
//     testStraightFlushBoard = new Board([
//       new Card("3d"),
//       new Card("4d"),
...
//     expect(holdem.handStrength(testHighCardBoard)).to.eql([
//       0,
//       14,
//       13,
//       12,
...
// xescribe("Compare Hands", function () {
//   before(function () {
//     hand1 = new Board([
//       new Card("3d"),
//       new Card("3h"),
